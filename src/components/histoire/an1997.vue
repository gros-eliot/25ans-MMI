...
<template>
  ...
  <section
    class="histoire-margins-for-section text-beige mt-20 lg:my-10 bg-[linear-gradient(90deg,rgba(0,0,0,1)0%,rgba(0,0,0,0.1)50%,rgba(0,0,0,1)100%),linear-gradient(0deg,rgba(0,0,0,1)0%,rgba(0,0,0,0.1)50%,rgba(0,0,0,1)100%),url('/images/histoire/space.jpg')] bg-cover bg-left-bottom"
  >
  ...
  >
    <div>
      <!--SRC experience-->
      <img
        src="/images/histoire/src-media.jpg"
        alt="SRC Media"
