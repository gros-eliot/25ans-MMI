...
function AnimationsHistoire() {
  ...
  if (valueScroll >= 500) {
    backgroundHistoire.style.backgroundImage =
      "linear-gradient(90deg,rgba(0,0,0,1)0%,rgba(0,0,0,0.3)50%,rgba(0,0,0,1)100%),linear-gradient(0deg,rgba(0,0,0,1)0%,rgba(0,0,0,0.3)50%,rgba(0,0,0,1)100%),url('src/images/histoire/prehistoric 2.jpg')";
  ...
  if (valueScroll >= 6500) {
    backgroundHistoire.style.backgroundImage =
      "linear-gradient(90deg,rgba(0,0,0,1)0%,rgba(0,0,0,0.3)50%,rgba(0,0,0,1)100%),linear-gradient(0deg,rgba(0,0,0,1)0%,rgba(0,0,0,0.3)50%,rgba(0,0,0,1)100%),url('src/images/histoire/bunker-src.jpg')";
